...
\paragraph{}
We began with creating \verb+FakeCallStart+ and \verb+FakeCallEnd+ classes, allowing us to initialize them with specific timestamps, which is useful for testing calls with pre-specified time periods.  We then extracted interfaces for \verb+BillGenerator+, allowing us to test behaviour of classes depending on it via mock tests.
